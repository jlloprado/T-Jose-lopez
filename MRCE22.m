% Este es el escenario II de la tesis, parto del modelo MRC1 este modela el 
...
% primero llamo la funcion del modelo de la MG1 para MTTRL horas. 
                   k1=MTTRL;
                   [B,E11,E12]=MRMG1(M,k1,CPLP11,CPLP12,MTTFA1,MTTFPV1);
...
% primero llamo la funcion del modelo de generacion para MTTRL horas.
                   k1=MTTRL;
                   [B,E13,E14]=MRMG2(M,k1,CPLP13,CPLP14,MTTFA2,MTTFPV2);

% Este es el escenario III de la tesis, parto del modelo MRC1 este modela 
% el sistema real colombiano, pero sin MG y teniendo en cuenta la carga 
...
% lambdas para el tranformador
    ...
    lambT21=0;
    lambT22=0;
% lambdas para los sistemas de generacion PV
    lambPV1=0;
    lambPV2=0;
...
% primero llamo la funcion del modelo de la MG1 para MTTRL horas. 
                   k1=MTTRL;
                   [B,E11,E12]=MRMG1E3(M,k1,CPLP11,CPLP12,MTTFMT1,MTTFPV1);
...
% primero llamo la funcion del modelo de generacion para MTTRL horas.
                   k1=MTTRL;
                   [B,E13,E14]=MRMG2E3(M,k1,CPLP13,CPLP14,MTTFMT2,MTTFPV2);

% Este es el escenario I de la tesis, parto del modelo MRC1 este modela el 
...
% este escenario se tienen que ingresar solo el modelo generacion PV. 
...
% lambda para las lineas de 1,5 por km,  
...
% primero llamo la funcion del modelo de la MG1 para MTTRL horas. 
                   k1=MTTRL;
                   [B,E11,E12]=MRMG1E1(M,k1,CPLP11,CPLP12,MTTFPV1);
...
% primero llamo la funcion del modelo de generacion para MTTRL horas.
                   k1=MTTRL;
                   [B,E13,E14]=MRMG2E1(M,k1,CPLP13,CPLP14,MTTFPV2);
...
% para los puntos de carga en las MGs
   ...
   %figure,plot(EENSF1DP)
   %hold on
   subplot(2,2,1), plot(LambPSLP14),title('λ del Punto de Carga 14'),set(gca,'fontsize',10), xlabel('Muestras(Año)'),ylabel('Fallas/Año');
   subplot(2,2,2), plot(PULP14),title('U del Punto de Carga 14'),set(gca,'fontsize',10), xlabel('Muestras(Año)'),ylabel('Horas');
   subplot(2,2,3), plot(SAIFIF1DP),title('SAIFI para el Alimentador F1'),set(gca,'fontsize',10), xlabel('Muestras(Año)'),ylabel('Interrupciones Cliente/Año');
   subplot(2,2,4), plot(EENSF1DP),title('EENS para el Alimentador F1'),set(gca,'fontsize',10), xlabel('Muestras(Año)'),ylabel('Wh/Año');
   %plot(PULP14)
   %plot(SAIFIF1DP)
   %plot(EENSF1DP)
   %title('EENS para el Alimentador F1')
   %set(gca,'fontsize',14);
   %xlabel('Muestras(año)')
   %ylabel('Wh/Año')
   %axis([0 years 0 10]); 
   %legend('λLP14','ULP14','SAIFIF1','EENSF1')

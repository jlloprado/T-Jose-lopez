% Este es el escenario V de la tesis, parto del modelo MRC1 este modela el 
...
% este escenario se tienen que ingresar los modelos de almacenamiento, 
% generacion PV y generacion MT. 
...
%Ingreso los datos para el Modelo de Generacion MT
% lamdda para cada sistema de generacion, es la misma
 lamMT=0.18;
% Defino los MTTR para cada sistema de generacion  
 MTTRMT=12;
...
% lambdas para los sistemas de almacenamiento
    lambA1=0;
    lambA2=0;
% lambdas para los sistemas de generacion MT
    lambMT1=0; 
    lambMT2=0;
...
% Creo los numeros aleatorios entre [0 1], para cada sistema de almacenamiento
    UA1=rand;
    UA2=rand;
% Creo los numeros aleatorios entre [0 1], para cada sistema MT
    UMT1=rand;
    UMT2=rand;
...
% Calculo MTTF para cada sistema MT 
    MTTFMT1=-(log(UMT1)/lamMT)*8760; 
    MTTFMT2=-(log(UMT2)/lamMT)*8760;
...
% creo una matriz o vector con los MTTF, sin incluir los de los sistemas PV,MT y ESS 
...
% primero llamo la funcion del modelo de la MG1 para MTTRL horas. 
                   k1=MTTRL;
                   [B,E11,E12]=MRMG1E5(M,k1,CPLP11,CPLP12,MTTFA1,MTTFMT1,MTTFPV1);
...
% primero llamo la funcion del modelo de generacion para MTTRL horas.
                   k1=MTTRL;
                   [B,E13,E14]=MRMG2E5(M,k1,CPLP13,CPLP14,MTTFA2,MTTFMT2,MTTFPV2);
